...
WorkoutPlan? pickFeaturedPlan(List<WorkoutPlan> plans) {
  ...
  next.sort((a, b) {
    final da = DateTime(
      a.scheduledDate.year, a.scheduledDate.month, a.scheduledDate.day,
      a.scheduledTime.hour, a.scheduledTime.minute,
    );
    final db = DateTime(
      b.scheduledDate.year, b.scheduledDate.month, b.scheduledDate.day,
      b.scheduledTime.hour, b.scheduledTime.minute,
    );
  ...
  Widget build(BuildContext context) {
    ...
    return PremiumBackground(
      child: SingleChildScrollView(
        ...
        child: Padding(
          padding: EdgeInsets.fromLTRB(AppSpacing.md, topPad + 4, AppSpacing.md, 0),
          child: Column(
            ...
            children: [
              ...
              HomeTopTabs(
                labels: [l10n.homeTabDashboard, l10n.homeTabWorkouts],
