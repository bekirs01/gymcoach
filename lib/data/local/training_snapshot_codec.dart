...
Map<String, dynamic> _encodeProfile(UserProfile p) {
  return {
    ...
    'trainingReminderTime': p.trainingReminderTime,
    'trainingReminderDays': p.trainingReminderDays,
    'bio': p.publicBio,
...
UserProfile _decodeProfile(Map<String, dynamic> m) {
  ...
  return UserProfile(
    ...
    preferredUnits: m['preferredUnits'] as String? ?? 'metric',
    trainingReminderTime: m['trainingReminderTime'] as String? ?? '19:00',
    trainingReminderDays: m['trainingReminderDays'] as String? ?? 'every_day',
